  ...
  reportResults(result: SecurityResult): void {
    ...
    if (!passed) {
      ...
      if (result.critical > 0)
        console.log("  - Fix critical vulnerabilities immediately");
      if (result.high > 0)
        console.log("  - Address high severity vulnerabilities");
      if (result.moderate > 0)
        console.log("  - Review moderate severity vulnerabilities");
