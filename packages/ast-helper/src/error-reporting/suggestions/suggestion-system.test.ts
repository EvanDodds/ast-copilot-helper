...
describe('SuggestionEngine', () => {
  ...
  describe('suggestion generation', () => {
    it('should generate suggestions for module not found error', async () => {
      ...
      const suggestionTitles = result.suggestions.map(s => s.title.toLowerCase());
      const hasModuleRelatedSuggestion = suggestionTitles.some(title => 
        title.includes('module') || title.includes('install') || title.includes('package')
      );
...
describe('PatternBasedSuggestionGenerator', () => {
  ...
  describe('pattern statistics', () => {
    it('should track pattern statistics', () => {
      ...
      const modulePattern = updatedStats.find(s => s.id === 'module-not-found');
...
describe('StaticAnalysisGenerator', () => {
  ...
  describe('error analysis', () => {
    ...
    it('should analyze syntax errors', async () => {
      ...
      const syntaxSuggestion = suggestions.find(s => 
