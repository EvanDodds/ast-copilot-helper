...
describe('FileSystemTester', () => {
    ...
    describe('file system compatibility tests', () => {
        ...
        it('should detect case sensitivity correctly', async () => {
            ...
            const caseSensitivityTest = result.testResults.find(
                test => test.name.toLowerCase().includes('case sensitivity')
            );
        ...
        it('should test path separator handling', async () => {
            ...
            const pathSeparatorTest = result.testResults.find(
                test => test.name.toLowerCase().includes('path separator')
            );
        ...
        it('should test special characters in filenames', async () => {
            ...
            const specialCharTests = result.testResults.filter(
                test => test.name.toLowerCase().includes('special characters')
            );
        ...
        it('should test file permissions (POSIX systems)', async () => {
            ...
            const permissionTests = result.testResults.filter(
                test => test.name.toLowerCase().includes('permission')
            );
        ...
        it('should test long path support', async () => {
            ...
            const longPathTest = result.testResults.find(
                test => test.name.toLowerCase().includes('long path')
            );
        ...
        it('should test Unicode support', async () => {
            ...
            const unicodeTests = result.testResults.filter(
                test => test.name.toLowerCase().includes('unicode')
            );
        ...
        it('should test symbolic link support', async () => {
            ...
            const symlinkTest = result.testResults.find(
                test => test.name.toLowerCase().includes('symbolic link')
            );
        ...
        it('should test hard link support', async () => {
            ...
            const hardlinkTest = result.testResults.find(
                test => test.name.toLowerCase().includes('hard link')
            );
        ...
        it('should test file attributes and metadata', async () => {
            ...
            const attributesTest = result.testResults.find(
                test => test.name.toLowerCase().includes('attributes')
            );
        ...
        it('should test directory operations', async () => {
            ...
            const directoryTests = result.testResults.filter(
                test => test.name.toLowerCase().includes('directory')
            );
        ...
        it('should test file watching capabilities', async () => {
            ...
            const watchingTest = result.testResults.find(
                test => test.name.toLowerCase().includes('watching')
            );
        ...
        it('should test concurrent file access', async () => {
            ...
            const concurrentTest = result.testResults.find(
                test => test.name.toLowerCase().includes('concurrent')
            );
        ...
        it('should provide meaningful error messages for failures', async () => {
            ...
            failedTests.forEach(test => {
                expect(test.error || test.details?.error || test.details?.expectedFailure).toBeDefined();
            });
        });
    });
        ...
        it('should distinguish between expected and unexpected failures', async () => {
            ...
            failedTests.forEach(test => {
                ...
                expect(
                    ...
                    test.details?.expectedFailure === true
                ).toBe(true);
            });
        });
