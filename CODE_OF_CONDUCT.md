...
In addition to general community standards, we also maintain technical standards for code contributions:

- **Code Quality**: Maintain high code quality with proper testing and documentation
- **Constructive Feedback**: Provide constructive, actionable code review feedback
- **Malicious Code**: Never submit malicious code, backdoors, or intentional security vulnerabilities
- **License Compliance**: Respect licensing requirements and intellectual property

### Technical Misconduct

Technical misconduct includes but is not limited to:
...
conduct@ast-copilot-helper.dev.
