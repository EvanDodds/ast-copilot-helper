...
describe('ParseCommand', () => {
  ...
  describe('Option Validation', () => {
    it('should validate preconditions successfully with valid config', async () => {
      ...
      await expect(parseCommand.execute(options, mockConfig)).rejects.toThrow('Configuration-based file selection not yet implemented');
    });
    ...
    it('should reject missing outputDir in config', async () => {
      ...
      await expect(parseCommand.execute(options, invalidConfig)).rejects.toThrow(
    ...
    it('should accept valid batch size', async () => {
      ...
      await expect(parseCommand.execute(options, mockConfig)).rejects.toThrow('not yet implemented');
    });
  ...
  describe('File Selection Strategy Detection', () => {
    it('should detect changed files strategy', async () => {
      ...
      await expect(parseCommand.execute(options, mockConfig)).rejects.toThrow('Git integration not yet implemented');
    });
    ...
    it('should detect glob pattern strategy', async () => {
      ...
      await expect(parseCommand.execute(options, mockConfig)).rejects.toThrow('Glob pattern selection not yet implemented');
    });
  ...
  describe('Utility Methods', () => {
    it('should format bytes correctly', () => {
      ...
      const formatBytes = (parseCommandInstance as any).formatBytes.bind(parseCommandInstance);
    ...
    it('should format duration correctly', () => {
      ...
      // Access private method for testing through type assertion
      const formatDuration = (parseCommandInstance as any).formatDuration.bind(parseCommandInstance);
