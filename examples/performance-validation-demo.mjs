...
async function main() {
  ...
  try {
    ...
    if (testBenchmark) {
      ...
      console.log(
        `   ✓ Value: ${result.measurement.value}${result.measurement.unit}`,
      );
    ...
    console.log(
      `   ✓ Peak Memory: ${(memoryProfile.peak / (1024 * 1024)).toFixed(2)} MB`,
    );
    console.log(
      `   ✓ Average Memory: ${(memoryProfile.average / (1024 * 1024)).toFixed(2)} MB`,
    );
    console.log(`   ✓ Memory Leak Detected: ${memoryProfile.leakDetected}`);
    console.log(
      `   ✓ GC Pressure: ${(memoryProfile.gcPressure * 100).toFixed(1)}%`,
    );
    ...
    console.log(
      `   ✓ Critical Failures: ${validation.overall.criticalFailures}`,
    );
    console.log(`   ✓ Total Benchmarks: ${validation.overall.totalBenchmarks}`);
    console.log(
      `   ✓ Categories: ${Object.keys(validation.categories).length}`,
    );
