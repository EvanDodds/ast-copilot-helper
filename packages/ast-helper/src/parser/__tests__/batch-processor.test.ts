  ...
  describe('BatchProcessor', () => {
    describe('basic batch processing', () => {
      ...
      it('should handle parse errors gracefully when continueOnError is true', async () => {
        ...
        mockParser.setMockResult('/test/good.ts', {
          nodes: [{ id: '1', type: 'test', filePath: '/test/good.ts', start: { line: 1, column: 0 }, end: { line: 1, column: 5 }, children: [], metadata: { language: 'typescript', scope: [], modifiers: [] } }],
          errors: [],
          language: 'typescript',
          parseTime: 10,
        });
        ...
        let callCount = 0;
        mockParser.parseFile = vi.fn().mockImplementation((filePath: string) => {
          callCount++;
    ...
    describe('file validation and filtering', () => {
      it('should skip unsupported file types', async () => {
        ...
        expect(unsupportedResult?.errors[0]?.message).toContain('Unsupported file type');
      });
    ...
    describe('caching', () => {
      it('should cache results when enabled', async () => {
        ...
        // First run
        await batchProcessor.processBatch(files, { enableCache: true, includeContentHashes: true });
    ...
    describe('performance metrics', () => {
      ...
      it('should track language-specific statistics', async () => {
        ...
        mockParser.setMockResult('/test/file.ts', {
          nodes: [{ id: '1', type: 'test', filePath: '/test/file.ts', start: { line: 1, column: 0 }, end: { line: 1, column: 5 }, children: [], metadata: { language: 'typescript', scope: [], modifiers: [] } }],
          errors: [],
          language: 'typescript',
          parseTime: 10,
        });
        ...
        mockParser.setMockResult('/test/file.js', {
          nodes: [{ id: '1', type: 'test', filePath: '/test/file.js', start: { line: 1, column: 0 }, end: { line: 1, column: 5 }, children: [], metadata: { language: 'javascript', scope: [], modifiers: [] } }],
          errors: [],
          language: 'javascript',
          parseTime: 15,
        });
