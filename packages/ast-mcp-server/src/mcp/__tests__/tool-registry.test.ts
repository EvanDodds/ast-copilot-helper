  ...
  describe("tool execution", () => {
    ...
    it("should validate parameters before execution", async () => {
      ...
      await expect(
        ...
        "Invalid parameters: Required parameter 'query' is missing",
      );
    });
  ...
  describe("parameter validation", () => {
    ...
    it("should validate parameter types", async () => {
      ...
      await expect(
        ...
        "Parameter 'string_param' must be of type string, got number",
      );

      // Wrong array type
      await expect(
        registry.executeTool("type-validation-tool", {
          array_param: "not-array",
        }),
