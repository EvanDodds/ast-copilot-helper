...
import { SecurityConfig, SecurityConfigPresets, SecurityValidator } from '../../packages/ast-helper/src/security-compliance/index.js';
import type { SecurityValidationConfig, SecurityCategory } from '../../packages/ast-helper/src/security-compliance/types.js';
...
describe('Security and Compliance Validation', () => {
  describe('SecurityConfig', () => {
    ...
    it('should merge custom configuration', () => {
      ...
      expect(configData.vulnerabilityScanning.sources).toEqual(['custom-source']);
    ...
    it('should update category configuration', () => {
      ...
      const vulnConfig = config.getCategoryConfig('vulnerability-scanning') as SecurityValidationConfig['vulnerabilityScanning'];
    ...
    it('should export/import JSON configuration', () => {
      ...
      expect(importedData.vulnerabilityScanning.enabled).toBe(originalData.vulnerabilityScanning.enabled);
    });
  });
  ...
  describe('SecurityValidator', () => {
    ...
    it('should emit events during validation', async () => {
      ...
      validator.runValidation = vi.fn().mockImplementation(async () => {
        validator.emit('test:start', { category: 'vulnerability-scanning' as SecurityCategory, testName: 'test' });
    ...
    it('should handle validation errors gracefully', async () => {
      ...
      validator.runValidation = vi.fn().mockRejectedValue(new Error('Mock validation error'));
