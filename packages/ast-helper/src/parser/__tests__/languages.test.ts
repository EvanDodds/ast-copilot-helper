      ...
      for (const config of SUPPORTED_LANGUAGES) {
        for (const ext of config.extensions) {
          if (extensionsMap.has(ext)) {
            throw new Error(
              `Duplicate extension ${ext} found in ${config.name} and ${extensionsMap.get(ext)}`,
            );
          }
  ...
  describe("LanguageDetector", () => {
    describe("detectLanguage", () => {
      it("should detect TypeScript files", () => {
        ...
        expect(LanguageDetector.detectLanguage("component.tsx")).toBe(
          "typescript",
        );
        expect(LanguageDetector.detectLanguage("/path/to/file.ts")).toBe(
          "typescript",
        );
      });
      ...
      it("should detect JavaScript files", () => {
        ...
        expect(LanguageDetector.detectLanguage("component.jsx")).toBe(
          "javascript",
        );
        expect(LanguageDetector.detectLanguage("module.mjs")).toBe(
          "javascript",
        );
        expect(LanguageDetector.detectLanguage("common.cjs")).toBe(
          "javascript",
        );
      });
    ...
    describe("getLanguageByExtension", () => {
      ...
      it("should return null for unsupported extensions", () => {
        ...
        expect(LanguageDetector.getLanguageByExtension("config.yaml")).toBe(
          null,
        );
      });
    });
    ...
    describe("isExtensionSupported", () => {
      ...
      it("should return false for unsupported extensions", () => {
        ...
        expect(LanguageDetector.isExtensionSupported("config.yaml")).toBe(
          false,
        );
      });
    });
    ...
    describe("addLanguage", () => {
      ...
      it("should replace existing language configuration", () => {
        const originalTsConfig =
          LanguageDetector.getLanguageConfig("typescript");
    ...
    describe("detectLanguageFromContent", () => {
      it("should detect TypeScript from content", () => {
        ...
        expect(
          LanguageDetector.detectLanguageFromContent("unknown.txt", tsContent),
        ).toBe("typescript");
      });
      ...
      it("should detect JavaScript from content", () => {
        ...
        expect(
          LanguageDetector.detectLanguageFromContent("unknown.txt", jsContent),
        ).toBe("javascript");
      });
      ...
      it("should detect Python from content", () => {
        ...
        expect(
          LanguageDetector.detectLanguageFromContent("unknown.txt", pyContent),
        ).toBe("python");
      });
      ...
      it("should prefer extension-based detection", () => {
        ...
        expect(
          LanguageDetector.detectLanguageFromContent("test.ts", jsContent),
        ).toBe("typescript");
      });
      ...
      it("should return null for unrecognizable content", () => {
        ...
        expect(
          LanguageDetector.detectLanguageFromContent(
            "unknown.txt",
            textContent,
          ),
        ).toBe(null);
