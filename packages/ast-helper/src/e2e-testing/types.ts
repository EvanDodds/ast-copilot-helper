...
export type EnvironmentRequirement = 'cli' | 'mcp-server' | 'vscode-extension' | 'database' | 'network';
...
export type CodebaseType = 'typescript' | 'javascript' | 'python' | 'java' | 'mixed';
export type CodebaseSize = 'small' | 'medium' | 'large' | 'enterprise';
export type ComplexityLevel = 'simple' | 'moderate' | 'complex' | 'highly-complex';
export type UserType = 'developer' | 'architect' | 'analyst' | 'manager' | 'automated';
export type UserAction = 'query' | 'analyze' | 'navigate' | 'modify' | 'collaborate';
export type FailureType = 'network' | 'service' | 'resource' | 'data' | 'timeout';
export type RecoveryStrategy = 'retry' | 'fallback' | 'graceful-degradation' | 'manual';
...
export type E2EErrorType = 'assertion' | 'timeout' | 'network' | 'resource' | 'system' | 'data';
...
export type ResourceLeakType = 'memory' | 'file-handles' | 'connections' | 'threads' | 'cache';
