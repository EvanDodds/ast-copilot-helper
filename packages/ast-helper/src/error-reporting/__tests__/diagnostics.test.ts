  ...
  describe('CodebaseDiagnosticCollector', () => {
    ...
    it('should collect codebase diagnostic data', async () => {
      ...
      if (data.codebase) {
        ...
        expect(data.codebase.structure.totalDirectories).toBeGreaterThanOrEqual(0);
        ...
        expect(data.codebase.complexity.averageLinesPerFile).toBeGreaterThanOrEqual(0);
        expect(data.codebase.complexity.totalLinesOfCode).toBeGreaterThanOrEqual(0);
      }
    });
  });
