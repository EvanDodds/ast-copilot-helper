...
const interfacesDoc = readFileSync(
  join(API_DOCS_DIR, "interfaces.md"),
  "utf-8",
);
...
const vscodeDoc = readFileSync(
  join(API_DOCS_DIR, "vscode-extension.md"),
  "utf-8",
);
...
console.log(
  "6️⃣  Checking for interactive examples and auto-generation support...",
);
...
if (hasInteractiveElements) {
  ...
  console.log(
    "⚠️  No interactive elements detected (consider adding code groups)\n",
  );
}
...
console.log("📋 Summary:");
console.log(
  "   ✅ CLI Commands Reference - Complete with examples and options",
);
...
console.log(
  "   ✅ VS Code Extension API - Complete with implementation examples",
);
