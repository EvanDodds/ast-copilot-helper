...
import { UnifiedMemoryManager, type MemoryManagerConfig } from '../../../memory/memory-manager.js';
...
describe('UnifiedMemoryManager', () => {
  ...
  describe('Integration Points', () => {
    ...
    it('should coordinate with metrics collector', async () => {
      ...
      const recommendations = await subsystems.metricsCollector.getPerformanceRecommendations();
  ...
  describe('Error Handling', () => {
    it('should handle start errors gracefully', async () => {
      ...
      vi.spyOn(subsystems.gcScheduler, 'start').mockRejectedValue(new Error('Start failed'));
    ...
    it('should handle stop errors gracefully', async () => {
      ...
      const subsystems = manager.getSubsystems();
      vi.spyOn(subsystems.metricsCollector, 'stop').mockRejectedValue(new Error('Stop failed'));
