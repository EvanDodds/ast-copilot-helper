...
describe('ASTDatabaseManager', () => {
    ...
    describe('database structure validation', () => {
        ...
        it('should detect missing directories', async () => {
            ...
            expect(result.errors.some((e: string) => e.includes('Missing required directory'))).toBe(true);
        });
        ...
        it('should detect missing configuration files', async () => {
            ...
            expect(result.errors.some((e: string) => e.includes('config.json'))).toBe(true);
            expect(result.errors.some((e: string) => e.includes('version.json'))).toBe(true);
        });
    });
