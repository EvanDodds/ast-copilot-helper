...
const publicNode = {
  ...
  metadata: { language: "python", scope: [], modifiers: [] },
};
const protectedNode = {
  id: "2",
  type: "function",
...
console.log(
  ...
  extractor.extractAccessModifiers(publicNode, ""),
);
console.log(
  "Protected function modifiers:",
  extractor.extractAccessModifiers(protectedNode, ""),
);
console.log(
  "Private function modifiers:",
  extractor.extractAccessModifiers(privateNode, ""),
);
console.log(
  "Magic method modifiers:",
  extractor.extractAccessModifiers(magicNode, ""),
);
