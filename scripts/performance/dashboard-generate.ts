 ...
 * benchmark comparisons, and regression analysis for vector database testing.
 *
 * Usage:
 *   yarn performance:dashboard
 *   tsx scripts/performance/dashboard-generate.ts
 *   tsx scripts/performance/dashboard-generate.ts --open  # Open in browser after generation
 */
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Vector Database Testing Framework | Last updated: ${new Date(data.generatedAt).toLocaleString()}</p>
        </div>
    </div>
