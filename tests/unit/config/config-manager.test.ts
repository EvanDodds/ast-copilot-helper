...
import type { CliArgs, Config, PartialConfig } from '../../../packages/ast-helper/src/types';
...
describe('Configuration Manager', () => {
    ...
    beforeEach(() => {
        ...
        mockValidateConfig = vi.mocked(validateConfig).mockReturnValue(mockDefaultConfig);
        mockParseEnvironmentConfig = vi.mocked(parseEnvironmentConfig).mockReturnValue({});
    ...
    describe('loadConfig', () => {
        ...
        it('should merge only supported properties', async () => {
            ...
            await configManager.loadConfig('/test/workspace', configWithSupportedProps);
