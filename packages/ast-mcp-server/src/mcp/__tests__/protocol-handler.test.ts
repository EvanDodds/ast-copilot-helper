...
import { MCPRequest, MCPResponse, MCPErrorCode, MCPError } from '../protocol/types';
...
describe('MCPProtocolHandler', () => {
  ...
  describe('createSuccessResponse', () => {
    it('should create valid success response', () => {
      const response = MCPProtocolHandler.createSuccessResponse(1, { success: true });
    ...
    it('should handle null id', () => {
      const response = MCPProtocolHandler.createSuccessResponse(null, { success: true });
    ...
    it('should handle string id', () => {
      const response = MCPProtocolHandler.createSuccessResponse('test-id', { success: true });
  ...
  describe('createErrorResponse', () => {
    it('should create valid error response', () => {
      const error = { code: MCPErrorCode.INVALID_REQUEST, message: 'Invalid request' };
  ...
  describe('utility methods', () => {
    ...
    it('should check protocol version compatibility', () => {
      expect(MCPProtocolHandler.isCompatibleProtocolVersion('2024-11-05')).toBe(true);
      expect(MCPProtocolHandler.isCompatibleProtocolVersion('2024-10-01')).toBe(false);
      expect(MCPProtocolHandler.isCompatibleProtocolVersion('2025-01-01')).toBe(false);
    });

    it('should return supported protocol version', () => {
      expect(MCPProtocolHandler.getSupportedProtocolVersion()).toBe('2024-11-05');
    });
  });
});