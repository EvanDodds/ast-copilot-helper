...
describe('Telemetry System Integration', () => {
  ...
  describe('Component Instantiation', () => {
    it('should create telemetry manager instance', () => {
      const manager = new PrivacyRespectingTelemetryManager(DEFAULT_TELEMETRY_CONFIG);
  ...
  describe('Factory Functions', () => {
    it('should have transmission factory functions available via import', async () => {
      ...
      expect(typeof transmissionModule.createDevelopmentTransmitter).toBe('function');
      expect(typeof transmissionModule.createProductionTransmitter).toBe('function');
      expect(typeof transmissionModule.createCustomTransmitter).toBe('function');
    });
    ...
    it('should have collection factory functions available via import', async () => {
      ...
      expect(typeof collectionModule.createDevelopmentCollector).toBe('function');
      expect(typeof collectionModule.createProductionCollector).toBe('function');
