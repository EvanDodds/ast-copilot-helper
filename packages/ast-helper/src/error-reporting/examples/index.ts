...
async function runAllExamples() {
  ...
  console.log(
    `📈 Success Rate: ${((completed / examples.length) * 100).toFixed(1)}%`,
  );

  if (completed === examples.length) {
    console.log("\n🎉 All examples completed successfully!");
    console.log(
      "💡 The error reporting system is fully functional and ready for use.",
    );
  } else if (failed > 0) {
    console.log(
  ...
  const examples = [
    {
      key: "1",
      name: "basic-usage",
      description: "Basic error reporting and suggestions",
    },
    {
      key: "2",
      name: "error-types",
      description: "Different error types and severities",
    },
    {
      key: "3",
    ...
    },
    {
      ...
      description: "Custom error categories and handling",
    },
    {
      key: "5",
      name: "privacy-focused",
      description: "Privacy-first error reporting",
    },
    {
      key: "6",
    ...
    },
    {
      ...
      description: "Data anonymization capabilities",
    },
    {
      key: "8",
      name: "analytics",
    ...
    },
    {
      key: "10",
      name: "crash-handling",
      description: "Advanced crash detection and recovery",
    },
    {
      key: "11",
