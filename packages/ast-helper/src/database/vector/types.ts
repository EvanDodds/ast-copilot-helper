...
export interface VectorDatabase {
  ...
  insertVector(nodeId: string, vector: number[], metadata?: VectorMetadata): Promise<void>;
  insertVectors(vectors: VectorInsert[]): Promise<void>;
  searchSimilar(queryVector: number[], k?: number, ef?: number): Promise<SearchResult[]>;
 ...
 */
export function createVectorDBConfig(partial: Partial<VectorDBConfig>): VectorDBConfig {
  return {
