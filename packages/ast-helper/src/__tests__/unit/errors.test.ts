...
describe('Error Utilities', () => {
  ...
  describe('CircuitBreaker', () => {
    ...
    it('should open circuit after failure threshold', async () => {
      ...
      await expect(circuitBreaker.execute('test'))
  ...
  describe('AggregateError', () => {
    it('should collect multiple errors', () => {
      ...
      const aggregate = new AggregateError(errors, 'Multiple failures occurred');
  ...
  describe('executeWithErrorCollection', () => {
    ...
    it('should collect errors when some fail', async () => {
      ...
      const { results, errors } = await executeWithErrorCollection(tasks, { continueOnError: true });
    ...
    it('should stop on first error when continueOnError is false', async () => {
      ...
      await expect(executeWithErrorCollection(tasks, { continueOnError: false }))
    ...
    it('should limit concurrency', async () => {
      ...
      const { results } = await executeWithErrorCollection(tasks, { maxConcurrency: 2 });
