...
describe('WebSocketTransport', () => {
  ...
  describe('connection management', () => {
    ...
    it('should simulate connections for testing', () => {
      const connectionId = transport.simulateConnection('127.0.0.1', 'test-client');
    ...
    it('should provide WebSocket-specific information', () => {
      const connectionId = transport.simulateConnection('192.168.1.1', 'custom-client');
  ...
  describe('error handling', () => {
    ...
    it('should track connection errors in statistics', async () => {
      ...
      const connection = transport.getConnections().find(c => c.id === connectionId);
