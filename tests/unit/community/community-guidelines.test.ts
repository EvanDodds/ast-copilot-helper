  ...
  describe('Code of Conduct', () => {
    ...
    describe('content structure', () => {
      ...
      it('should have our pledge section', () => {
        ...
        expect(cocContent).toContain('diverse, inclusive, and healthy community');
      });
  ...
  describe('Community Engagement Guide', () => {
    ...
    describe('formatting and structure', () => {
      ...
      it('should have table of contents', () => {
        ...
        expect(communityContent).toContain('[Community Overview](#community-overview)');
        expect(communityContent).toContain('[Getting Started](#getting-started)');
      });

      it('should have proper markdown tables', () => {
        expect(communityContent).toContain('| Channel | Expected Response Time |');
        expect(communityContent).toContain('| Severity | Response | Timeline |');
      });
      ...
      it('should have resource links', () => {
        expect(communityContent).toContain('[Code of Conduct](CODE_OF_CONDUCT.md)');
        expect(communityContent).toContain('[Contributing Guidelines](CONTRIBUTING.md)');
