...
export class PerformanceBenchmarker {
  ...
  async runBenchmarks(): Promise<BenchmarkResult> {
    console.log(`🔧 Running performance benchmarks on ${this.platform}/${this.architecture}`);
    ...
    const summary = this.generateSummary(testResults, duration, performanceMetrics);

    console.log(`✅ Performance benchmarks completed: ${summary.passed}/${summary.total} tests passed`);
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(avgReadTime, [10, 25, 50, 100])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          throughputBytesPerSec: throughput,
          performanceGrade: this.gradePerformance(avgWriteTime, [20, 50, 100, 200])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(totalTime, [500, 1000, 2000, 5000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(writeTime + readTime, [2000, 5000, 10000, 20000])
        }
      };
    } catch (error) {
      return {
      ...
      if (global.gc) {
        ...
        return {
          ...
          details: {
            ...
            gcTime,
            memoryUsedMB: (postAllocMemory.heapUsed - initialMemory.heapUsed) / 1024 / 1024,
            memoryFreedMB: (postAllocMemory.heapUsed - postGcMemory.heapUsed) / 1024 / 1024,
            heapTotalMB: postAllocMemory.heapTotal / 1024 / 1024,
            performanceGrade: this.gradePerformance(allocTime, [200, 500, 1000, 2000])
          }
        };
      } else {
        return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          memoryIncreaseMB: (postFragMemory.heapUsed - initialMemory.heapUsed) / 1024 / 1024,
          heapTotalMB: postFragMemory.heapTotal / 1024 / 1024,
          performanceGrade: this.gradePerformance(fragTime, [100, 250, 500, 1000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(totalTime, [200, 500, 1000, 2000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          result,
          operationsPerSecond,
          performanceGrade: this.gradePerformance(cpuTime, [1000, 2500, 5000, 10000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(mathTime, [100, 250, 500, 1000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(avgParseTime, [10, 25, 50, 100])
        }
      };
    } catch (error) {
      return {
  ...
  private async benchmarkTextParsing(): Promise<TestResult> {
    ...
    try {
      ...
      const testText = Array.from({ length: 10000 }, (_, i) => 
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(avgTextTime, [25, 50, 100, 200])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(concurrentTime, [200, 500, 1000, 2000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          performanceGrade: this.gradePerformance(streamTime, [200, 500, 1000, 2000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          memoryAllocatedMB: (postAllocMemory.heapUsed - initialMemory.heapUsed) / 1024 / 1024,
          memoryFreedMB: (postAllocMemory.heapUsed - postGcMemory.heapUsed) / 1024 / 1024,
          gcTime,
          totalTime,
          gcAvailable: !!global.gc,
          performanceGrade: global.gc ? this.gradePerformance(gcTime, [20, 50, 100, 200]) : 'N/A'
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          isLinearScaling,
          performanceGrade: this.gradePerformance(totalScalabilityTime, [1000, 2500, 5000, 10000])
        }
      };
    } catch (error) {
      return {
    ...
    try {
      ...
      return {
        ...
        details: {
          ...
          optimizationScore,
          platformTime,
          performanceGrade: this.gradePerformance(platformTime, [20, 50, 100, 200])
        }
      };
    } catch (error) {
      return {
  ...
  private generateSummary(testResults: TestResult[], duration: number, metrics: PerformanceMetrics): BenchmarkResult['summary'] {
    const total = testResults.length;
    const passed = testResults.filter(test => test.passed).length;
    const failed = total - passed;

    const avgExecutionTime = testResults.reduce((sum, test) => sum + test.duration, 0) / total;
    
    // Calculate efficiency scores (0-100)
    const memoryEfficiency = Math.max(0, 100 - (metrics.memoryUsage.heapUsed / 1024 / 1024)); // Lower memory = higher score
    const cpuEfficiency = Math.max(0, 100 - (metrics.cpuUsage.user + metrics.cpuUsage.system) / 100); // Lower CPU = higher score
    ...
    const scalabilityTest = testResults.find(test => test.name === 'scalability_performance');
    const scalabilityScore = scalabilityTest?.passed ? 85 : 60;
    
    // Calculate overall performance grade
    const overallScore = (memoryEfficiency + cpuEfficiency + diskIOEfficiency + scalabilityScore) / 4;
