...
import { MCPQuery, QueryResponse } from '../../../packages/ast-mcp-server/src/query/types';
...
describe('PerformanceMonitor', () => {
  ...
  describe('query response caching', () => {
    it('should cache and retrieve query responses', () => {
      ...
      const cachedResponse = performanceMonitor.getCachedQueryResponse(mockQuery);
  ...
  describe('embedding caching', () => {
    ...
    it('should return null for uncached text', () => {
      const cachedEmbedding = performanceMonitor.getCachedEmbedding('uncached text');
  ...
  describe('cache management', () => {
    it('should clear all caches', () => {
      ...
      expect(performanceMonitor.getCachedQueryResponse(mockQuery)).toEqual(mockResponse);
      expect(performanceMonitor.getCachedEmbedding('test text')).toEqual([0.1, 0.2]);
