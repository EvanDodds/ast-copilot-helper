  ...
  describe("Type Guards", () => {
    describe("isValidPosition", () => {
      it("should accept valid positions", () => {
        ...
        expect(isValidPosition({ line: 5, column: 12, offset: 100 })).toBe(
          true,
        );
      });
    ...
    describe("isValidASTNode", () => {
      ...
      it("should reject invalid nodes", () => {
        ...
        expect(isValidASTNode({ ...validNode, type: "invalid-type" })).toBe(
          false,
        );
        expect(isValidASTNode({ ...validNode, children: "not-array" })).toBe(
          false,
        );
