...
describe('Configuration Index', () => {
  ...
  describe('Default Configuration Usage', () => {
    it('should use default configuration as base', async () => {
      ...
      expect(devConfig.transport.type).toBe(DEFAULT_MCP_SERVER_CONFIG.transport.type);
    });
    ...
    it('should override specific properties while keeping defaults', async () => {
      ...
      expect(prodConfig.transport.type).toBe(DEFAULT_MCP_SERVER_CONFIG.transport.type);
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle partial overrides correctly', async () => {
      ...
      expect(config.transport.type).toBe(DEFAULT_MCP_SERVER_CONFIG.transport.type);
      expect(config.transport.host).toBe(DEFAULT_MCP_SERVER_CONFIG.transport.host);
    });
  });
