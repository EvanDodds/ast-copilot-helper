...
export class SearchSimilarHandler extends BaseHandler {
  ...
  static getDefinition(): MCPToolDefinition {
    return {
      name: "search-similar",
      description:
        "Search for code annotations similar to provided text using semantic similarity",
      inputSchema: {
        type: "object",
        properties: {
          text: {
          ...
          minScore: {
            type: "number",
            description:
              "Minimum similarity score threshold (default: 0.3, range: 0.0-1.0)",
            default: 0.3,
            minimum: 0.0,
            maximum: 1.0,
          },
...
export class SearchSignatureHandler extends BaseHandler {
      ...
      const signatureMatches = matches.filter((match) => {
        if (processedParams.exact) {
          ...
          return match.signature
            .toLowerCase()
            .includes(processedParams.signature.toLowerCase());
        }
      });
  ...
  static getDefinition(): MCPToolDefinition {
    return {
      ...
      description:
        "Search for code annotations by exact or partial function/method signature",
      inputSchema: {
        type: "object",
        properties: {
          signature: {
          ...
          exact: {
            type: "boolean",
            description:
              "Whether to perform exact signature matching (default: false)",
            default: false,
          },
          maxResults: {
            type: "number",
...
export class GetAnnotationHandler extends BaseHandler {
  ...
  static getDefinition(): MCPToolDefinition {
    return {
      name: "get-annotation",
      description:
        "Get detailed information about a specific code annotation by ID",
      inputSchema: {
        type: "object",
        properties: {
          id: {
          ...
          includeParent: {
            type: "boolean",
            description:
              "Include parent annotation information (default: false)",
            default: false,
          },
          includeSource: {
            type: "boolean",
      ...
      inputSchema: {
        ...
        properties: {
          filePath: {
            type: "string",
            description:
              "Optional specific file path to get statistics for (if omitted, returns overall stats)",
          },
          includeNodeTypes: {
            type: "boolean",
            description:
              "Include breakdown by annotation/node types (default: true)",
            default: true,
          },
          includeTimestamps: {
            type: "boolean",
            description:
              "Include creation and modification timestamps (default: true)",
            default: true,
          },
        },
        required: [],
