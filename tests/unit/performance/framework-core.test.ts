...
import {
  ...
  CPUMonitor,
  MemoryMonitor,
} from "../../../packages/ast-helper/src/performance/utils";
...
describe("Performance Framework Core", () => {
  ...
  describe("PerformanceTimer", () => {
    ...
    it("should assert performance thresholds", () => {
      expect(() =>
        PerformanceTimer.assertPerformance(100, 50, "test operation"),
      ).toThrow();
      expect(() =>
        PerformanceTimer.assertPerformance(50, 100, "test operation"),
      ).not.toThrow();
    });
  });
