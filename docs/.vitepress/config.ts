...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'ast-copilot-helper | AI-powered code understanding' }],
    ['meta', { property: 'og:site_name', content: 'ast-copilot-helper' }],
    ['meta', { property: 'og:image', content: '/ast-copilot-helper-og.png' }],
    ['meta', { property: 'og:url', content: 'https://ast-copilot-helper.dev/' }]
  ],
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/EvanDodds/ast-copilot-helper' }
    ],
    ...
    editLink: {
      pattern: 'https://github.com/EvanDodds/ast-copilot-helper/edit/main/docs/:path',
