...
describe("Monitoring and Notifications System", () => {
        ...
        stages: [
          {
            ...
            resourceUsage: { memory: 1200, cpu: 70 },
          },
          {
            name: "Test",
            duration: 120000,
            status: "success" as const,
            resourceUsage: { memory: 800, cpu: 60 },
          },
        ],
      };
  ...
  describe("MonitoringDashboard", () => {
    ...
    it("should generate comprehensive dashboard", async () => {
          ...
          stages: [
            {
              ...
              duration: 240000,
              status: "success" as const,
              resourceUsage: { memory: 1200, cpu: 65 },
            },
            {
              name: "Test",
              duration: 120000,
              status: "success" as const,
              resourceUsage: { memory: 800, cpu: 50 },
            },
          ],
        },
      ];
      ...
      const successRateMetric = result.metrics.find(
        (m) => m.id === "success-rate",
      );
    ...
    it("should calculate metrics with proper trends", async () => {
      ...
      const mockHistoryWithTrend = [
        {
          ...
          metrics: {
            ...
            deployTime: 50000,
            totalTime: 350000,
            memoryUsage: { peak: 1500, average: 1000 },
          ...
          stages: [
            {
              ...
              duration: 120000,
              status: "success" as const,
              resourceUsage: { memory: 900, cpu: 60 },
            },
          ],
        },
        {
          ...
          metrics: {
            ...
            deployTime: 70000,
            totalTime: 510000,
            memoryUsage: { peak: 2100, average: 1400 },
            cpuUsage: { peak: 80, average: 60 },
            artifactSize: 140,
            cacheHitRate: 70,
          },
          stages: [
            {
              ...
              duration: 140000,
              status: "success" as const,
              resourceUsage: { memory: 1000, cpu: 70 },
            },
          ],
        },
      ];
      ...
      vi.mocked(fs.existsSync).mockReturnValue(true);
      vi.mocked(fs.readFileSync).mockReturnValue(
        JSON.stringify(mockHistoryWithTrend),
      );
  ...
  describe("Integration Tests", () => {
    it("should integrate performance monitoring with alerting system", async () => {
      ...
      const report = await monitor.generateReport();
      const alerts = await alertingSystem.evaluateMetrics(
        report.currentBuild,
        [],
      );
